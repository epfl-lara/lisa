...
object Core:
   ...
   */
  final class SymbolInfo private[Core] (
      val id: Symbol,
      val name: String,
      val no: Int,
      val arity: Int,
   ...
   */
  sealed abstract class ClauseBody private[Core] (val literals: Array[Literal], val weight: Int, val posCount: Int, val negCount: Int, val predBits: Long):
   ...
   */
  final class QueryClause private[Core] (lits: Array[Literal], weight: Int, posCount: Int, negCount: Int, predBits: Long) extends ClauseBody(lits, weight, posCount, negCount, predBits):
