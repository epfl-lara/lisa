  ...
  if (subst.isEmpty) subst
    ...
    (first, second) match {
      case (BinderFormula(l1, b1, i1), BinderFormula(l2, b2, i2)) if l1 == l2 => {
        ...
        val innerSubst = matchFormula(substituteVariables(i1, Map[VariableLabel, Term](b1 -> t)), substituteVariables(i2, Map[VariableLabel, Term](b2 -> t)), Some((subst.get._1, subst.get._2 + ((t -> t): (VariableLabel, Term)))))
  ...
  if (subst.isEmpty) subst
    ...
    (first, second) match {
      case (BinderFormula(l1, b1, i1), BinderFormula(l2, b2, i2)) if l1 == l2 => {
        ...
        // add a safety substitution to make sure bound variable isn't substituted, and check instantiated bodies
        val innerSubst = unifyFormula(substituteVariables(i1, Map[VariableLabel, Term](b1 -> t)), substituteVariables(i2, Map[VariableLabel, Term](b2 -> t)), Some((subst.get._1, subst.get._2 + ((t -> t): (VariableLabel, Term)))))
