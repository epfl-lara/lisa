...
\begin{defin}[Formulas]
  ...
  $$
\end{defin}
\begin{ex}[Formula]The following are typical examples of formula labels:
  \begin{align*}
...
\begin{thm}[\cite{guilloudFormulaNormalizationsVerification2023a}]
  \label{thm:OL}
