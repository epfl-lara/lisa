...
object Orderings extends lisa.Main {
  ...
  val inclusionOrderElem = Lemma(
    ...
    val exXY = have(in(b, c) <=> exists(y, exists(x, in(y, x) /\ (pair(b, c) === pair(y, x))))) subproof {
      ...
      val bwd = have(exists(y, exists(x, in(y, x) /\ (pair(b, c) === pair(y, x)))) |- in(b, c)) subproof {
        ...
        thenHave((in(y, x), b === y, c === x) |- in(b, c)) by Substitution.applyRule(true, b === y, c === x)
  ...
  val inclusionIsRelation = Theorem(
    ...
    val subs = thenHave(subset(inclusionOn(a), cartesianProduct(a, a))) by Substitution.applyRule(true, subsetAxiom of (x -> inclusionOn(a), y -> cartesianProduct(a, a)))
  ...
  val emptyInclusionReflexive = Lemma(
    ...
    thenHave(thesis) by Substitution.applyRule(true, emptySetInclusionEmpty)
  }
  ...
  val emptySetPartialOrder = Lemma(
    ...
    ) by Substitution.applyRule(false, firstInPairReduction of (x -> emptySet(), y -> emptySet()), secondInPairReduction of (x -> emptySet(), y -> emptySet()))(
  ...
  val emptySetTotalOrder = Lemma(
    ...
    have(totalOrder(pair(emptySet(), emptySet())) <=> (partialOrder(pair(emptySet(), emptySet())) /\ total(emptySet(), emptySet()))) by Substitution.applyRule(
      false,
  ...
  val emptySetWellOrder = Lemma(
    ...
    ) by Substitution.applyRule(false, firstInPairReduction of (x -> emptySet(), y -> emptySet()))(wellOrder.definition of p -> pair(emptySet(), emptySet()))
  ...
  val transitiveSetInclusionDef = Theorem(
    ...
    have(forall(y, in(y, x) ==> subset(y, x)) <=> forall(z, forall(y, (in(z, y) /\ in(y, x)) ==> in(z, x)))) subproof {
      val lhs = have(forall(y, in(y, x) ==> subset(y, x)) |- forall(z, forall(y, (in(z, y) /\ in(y, x)) ==> in(z, x)))) subproof {
        ...
        thenHave((forall(y, in(y, x) ==> subset(y, x)), in(y, x)) |- forall(z, in(z, y) ==> in(z, x))) by Substitution.applyRule(false, subsetAxiom of (x -> y, y -> x))
      ...
      val rhs = have(forall(z, forall(y, (in(z, y) /\ in(y, x)) ==> in(z, x))) |- forall(y, in(y, x) ==> subset(y, x))) subproof {
        ...
        thenHave(forall(z, forall(y, (in(z, y) /\ in(y, x)) ==> in(z, x))) /\ in(y, x) |- subset(y, x)) by Substitution.applyRule(true, subsetAxiom of (x -> y, y -> x))
  ...
  val emptySetWellOrderedByInclusion = Lemma(
    ...
    have(wellOrder(pair(emptySet(), inclusionOn(emptySet())))) by Substitution.applyRule(true, emptySetInclusionEmpty)(emptySetWellOrder)
    thenHave(thesis) by Substitution.applyRule(true, incDef)
  }
  ...
  val ordinalsHeredetarilyTransitive = Lemma(
    ...
    val wellOrda = have(ordinal(a) |- wellOrder(pair(a, inclusionOn(a)))) by Substitution.applyRule(false, lastStep)(wellOrdInca)
    ...
    val cInb = have((in(b, a), in(z, b), in(c, z), in(c, a), in(z, a), wellOrder(pair(a, inclusionOn(a)))) |- in(c, b)) subproof {
      ...
      have(wellOrder(pair(a, inclusionOn(a))) |- forall(w, forall(y, forall(z, (in(pair(w, y), inclusionOn(a)) /\ in(pair(y, z), inclusionOn(a))) ==> in(pair(w, z), inclusionOn(a)))))) by Substitution
        .applyRule(false, secondInPairReduction of (x -> a, y -> inclusionOn(a)))(wellOrderTransitivity of p -> pair(a, inclusionOn(a)))
    ...
    thenHave((transitiveSet(a), wellOrder(pair(a, inclusionOn(a))), in(b, a)) |- transitiveSet(b)) by Substitution.applyRule(true, transitiveSetInclusionDef of x -> b)
