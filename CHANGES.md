...
## 2024-03-02
Addition of a tactic that proves a sequent by applying a generic theorem on some facts provided by the user. It can be used via `by Apply(thm).on(fact1, fact2,...)`. Replaces cases where using `Tautology` was overkilled.
## 2024-02-05
